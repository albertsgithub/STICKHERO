...
namespace MojingSample.CrossPlatformInput
{
    public partial class CrossPlatformInputManager : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            if (!useCrossInput)
            {
                CrossPlatformInputManager.virtualInput = new StandaloneInput();
                Object.Destroy(this);
                return;
            }

            CrossPlatformInputManager.virtualInput = new MobileInput();
            main = this;
        ...
        {
            CrossPlatformInputManager.timestamp = Time.frameCount;
